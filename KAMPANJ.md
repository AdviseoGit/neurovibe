...
Steg: 
[x] Diagnostisera adhd-diagnos-guide.html och bygg ut innehåll för sökintent.
[x] Förbättra internlänkning från index till adhd-diagnos-guide.html.
[x] Lägg till lead capture anpassad för adhd-diagnos.
[ ] Förbättra lead conversion rate och bygg distribution/gästinlägg om den inte rört sig tills pass 4.
