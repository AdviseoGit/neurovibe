outreach_md = """# B2B Outreach Strategy - Neurovibe
...
Neurovibe Team
"""
with open('/data/workspace/projects/neurovibe/content/b2b_outreach_strategy.md', 'w', encoding='utf-8') as f:
    f.write(outreach_md)
print("Outreach strategy created.")
